...
object Schema {
  import Attr._
  val allAttrs = Set(Properties, MinProperties, MaxProperties, MinItems, MaxItems, Type, Enum, Minimum, ExclusiveMinimum, Maximum, ExclusiveMaximum, MinLength, MaxLength, Not, Required, MultipleOf, AllOf, AnyOf, OneOf)
